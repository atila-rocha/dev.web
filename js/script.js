    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 col-xl-8">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header curriculum-bg text-white text-center py-4">
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    <div class="project-item mb-4 p-3 bg-light rounded">
                        ...
                        <a href="https://www.instagram.com/p/DMQDM1cu-wG/?utm_source=ig_web_copy_link&igsh=ZXgwYWE0Z3h2bXQ=" class="btn btn-outline-primary btn-sm">📱 Veja no Instagram</a>
                    </div>
